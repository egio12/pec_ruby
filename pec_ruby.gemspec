...
Gem::Specification.new do |spec|
  ...
  spec.description = 'A comprehensive Ruby library for handling Italian certified email (PEC) messages. ' \
                     'Supports nested PEC detection, extracting postacert.eml contents, attachment management, ' \
                     'and includes a CLI for exploring PEC messages. Features performance optimizations and ' \
